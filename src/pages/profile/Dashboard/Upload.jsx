...
export default function Upload({
  ...
  return (
    <div className="flex flex-col space-y-2 md:h-auto md:w-[570px]">
      ...
      <div
        className={`${
          isDragActive ? "bg-gray-200" : "bg-gray-700"
      ...
      >
        {previewSource ? (
          <div className="flex w-full flex-col p-6">
            ...
            {!viewData && (
              <button
                ...
                className="mt-3 h-auto overflow-y-hidden text-gray-400 underline"
              >
                Cancel
              </button>
            )}
          ...
          <div
            ...
            {...getRootProps()}
          >
            <input {...getInputProps()} ref={inputRef} id="upload-media" required type="file" />
